...
void Renderer::DrawTexture(std::weak_ptr<Texture> texture, const Transform& transform, bool hfilp)
{
	...
	// https://wiki.libsdl.org/SDL2/SDL_RenderCopyExF
	SDL_RenderCopyExF(m_renderer, texture.lock()->m_texture, NULL, &destRect, transform.rotation, NULL, (hfilp) ? SDL_FLIP_HORIZONTAL : SDL_FLIP_NONE);
}
